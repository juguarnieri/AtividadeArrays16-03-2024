...
let animals = ["pato", "cobra", "morcego", "elefante"];

console.log(animals); //[ 'pato', 'cobra', 'morcego', 'elefante' ] mostra todos os elementos presentes.

// O método pop() remove um item do array, sendo ele o último elemento do array. 
//Não atribui valor a variável.
animals.pop();

console.log("Lista correta dos animais:", animals); // Lista correta dos animais: [ 'pato', 'cobra', 'morcego' ] o último elemento foi removido.
